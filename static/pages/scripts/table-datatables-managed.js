var TableDatatablesManaged = function () {
    ...
    var initTable1 = function () {
        ...
        table.dataTable({
            ...
            "dom": "<'row'<'col-md-6 col-sm-12'l><'col-md-6 col-sm-12'f>r>t<'row'<'#op.col-md-4'><'col-md-4 text-center'i><'col-md-4 col-sm-8'p>>",
            //"dom": 'flt<"row"<"col-md-8"<"col-md-6"><"col-md-6 text-center"i>><"col-md-4"p>>'
		...
		var ht_text='<div class="table-actions-wrapper" id="actions">\
                    <span> </span>\
